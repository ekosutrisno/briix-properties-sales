<template>
    <section class="bg-gradient-to-b from-[#C7E7F4]/40 to-[#FFFFFF]/0 briix-container lg:my-[42px] lg:-mt-10 lg:pt-10">
...
<script>
import CardOurProperties from '../cards/CardOurProperties.vue';
export default {
    components: { CardOurProperties },
    data: ()=>({
        cards: [
            {
                id: 'e1c3439d-a64f-4ace-8b81-f07de474ac6a',
                bgImg: 'C1.png',
                logo: 'siwa-logo.png',
                subLogo: 'cliff-logo.png',
                soon: false
            },
            {
